...
export default function Privacy() {
    return (
        <>
            <Head title="Politique de Confidentialité - Mindfulness & Bien-être Studio" />
            ...
            <div className="relative min-h-screen pt-20">
                <div className="mx-auto max-w-4xl px-6 py-12 md:px-8">
                    ...
                    <div className="prose prose-neutral dark:prose-invert max-w-none text-foreground/80 space-y-6">
                        <p>
                            Chez <strong>Mindfulness & Bien-être Studio</strong>, nous accordons une importance primordiale à la protection de vos données personnelles et au respect de votre vie privée. Cette politique de confidentialité détaille les informations que nous collectons, comment nous les utilisons et vos droits à cet égard.
                        </p>
                        ...
                        <p>
                            Pour toute question concernant la protection de vos données personnelles ou pour faire valoir vos droits, vous pouvez nous écrire à : <strong>hello@mindfulness.com</strong>.
                        </p>
                    </div>
                </div>
            </div>
