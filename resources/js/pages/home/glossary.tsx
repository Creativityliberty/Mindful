...
const terms: GlossaryTerm[] = [
    ...
    },
    {
        ...
        courseUrl: '/courses/les-fondations-energetiques-chakra-racine',
    },
    {
    ...
    },
    {
        ...
        courseUrl: '/courses/meditation-pleine-conscience',
    },
    {
...
export default function Glossary() {
    ...
    return (
        <>
            <Head>
                <title>Glossaire des Pratiques Énergétiques & Radiesthésie | FormationSession</title>
                <meta
                    name="description"
                    content="Consultez notre glossaire complet des termes en radiesthésie, pendule divinatoire, chakras, taux vibratoire et méditation."
                />
            </Head>
                ...
                <div className="relative mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                    ...
                    >
                        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-border/40 bg-secondary px-4 py-2 text-xs font-semibold tracking-[0.25em] text-secondary-foreground uppercase backdrop-blur">
                            ...
                            Dictionnaire du Bien-être
                        </div>
                        <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl">
                            Glossaire des Pratiques Énergétiques
                        </h1>
                        <p className="mx-auto mt-4 max-w-xl text-base text-muted-foreground">
                            Retrouvez les définitions clés de la radiesthésie, du pendule, des chakras et du développement intérieur.
                        </p>
                    </motion.div>
                    ...
                    <div className="mb-12 relative max-w-xl mx-auto">
                        ...
                        <Input
                            type="search"
                            placeholder="Rechercher un terme (ex: Pendule, Bovis, Chakra...)"
                            value={search}
                            ...
                            >
                                ...
                                {item.relatedCourse && item.courseUrl && (
                                    <div className="pt-4 border-t border-border/30 flex items-center justify-between">
                                        <span className="text-xs text-muted-foreground font-medium">Formation liée :</span>
