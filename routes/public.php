...
use App\Http\Controllers\Public\Courses\FreeEnrollController;
...
Route::post('courses/{courseId}/enroll-free', [FreeEnrollController::class, 'store'])->middleware(['auth', 'verified'])->name('courses.enroll-free');
